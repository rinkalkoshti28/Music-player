...
// track of current song and current time

let userData = {
  songs: [...allSongs], // this will create a copy of allsongs array into songs variable
  currentSong: null, // it will store current song
  songCurrentTime: 0, // it will store song current time
};
...
// shuffle the song list by random method
const shuffle = () => {
...
// arrow function to display songs on screen
const renderSongs = (array) => {
  // to display each and every song details
...
// play button starts first song or current playing song
...
// previous song play event
previousButton.addEventListener("click", playPreviousSong);

// shuffle song event
shuffleButton.addEventListener("click", shuffle);

// song ended and starts next
...
// to sort songs list in alphabeitcal order
const sortSongs = () => {
